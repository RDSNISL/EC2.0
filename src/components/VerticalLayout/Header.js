          ...
          <Container fluid>
            <div className="float-end">
              ...
              <button
                ...
                onClick={() => {
                  dispatch(showRightSidebarAction(!layout.showRightSidebar));
                }}
              >
            ...
            <div>
              <div className="navbar-brand-box">
                ...
                <Link to="/" className="logo logo-light">
                  <span className="logo-sm">
                    {/* <img src={logoSm} alt="" height="20" /> */}
                    <img src={'https://www.narolainfotech.com/wp-content/uploads/2022/09/nisl-logo.svg'} alt="" height="20" />
                  </span>
                  <span className="logo-lg">
                    {/* <img src={logoLight} alt="" height="19" /> */}
                    <img src={'https://www.narolainfotech.com/wp-content/uploads/2022/09/nisl-logo.svg'} alt="" />
                  </span>
                </Link>
              </div>
              <button
